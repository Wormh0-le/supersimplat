# Current Final Spec v1.2 → Ticket Mapping — v2.10
...
ADR 0013, ADR 0014, ADR 0015 and DGs remain subordinate rationale.
...
| 02C    | §§1–5, 27–29                    | Automatic runtime readiness, operator-owned Active Model, minimal Availability UI |
