...
- For Chinese user-visible copy, follow [Chinese product and technical writing](chinese-writing.md). Use labels defined by the current product authority rather than inventing local synonyms.
