...
- Ticket graph and control plane promoted through v2.35 with ADR 0018, the
  ...
  semantic suspension/exact-Undo closure and Ticket 19 large-scene render-path
  hardening. The v2.35
...
→ 20 Same-decision GPU Evidence / artifact hardening (current)
```
