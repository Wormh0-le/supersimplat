# Final Spec v1.3 → Ticket Traceability Matrix — v2.33
...
| R040 | Tickets through 17 are implemented and Ticket 18 is the current ready frontier                                       | 09, 11, 12, 13, 14, 14A, 14B, 14C, 14D, 15, 16, 16A–16G, 17, 18 |
...
core and does not reintroduce the removed 3D More/Restart control. Ticket 18 is
current.
