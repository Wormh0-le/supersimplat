# Final Spec v1.3 → Ticket Traceability Matrix — v2.20
...
| R040 | Tickets through 12 and stages 14A–14B are implemented prerequisites; parent Ticket 14 is the current parent frontier; 14C is the current execution stage | 09, 11, 12, 14, 14A, 14B, 14C     |
