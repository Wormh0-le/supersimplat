# Final Spec v1.3 → Ticket Traceability Matrix — v2.19
...
| R040 | Tickets through 12 and stage 14A are implemented prerequisites; parent Ticket 14 is the current parent frontier; 14B is the current execution stage | 09, 11, 12, 14, 14A, 14B          |
