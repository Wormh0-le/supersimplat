# Final Spec v1.3 → Ticket Traceability Matrix — v2.25
...
| R040 | Tickets through 14D and Tickets 13 through 16 are implemented prerequisites; Ticket 17 is the current parent frontier | 09, 11, 12, 13, 14, 14A, 14B, 14C, 14D, 15, 16, 17 |
...
- current parent implementation frontier: 17;
