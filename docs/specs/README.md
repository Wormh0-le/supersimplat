...
8. implementation tickets and tests

The Final Spec and its normative amendments govern conflicts. DG-21 records rationale and ownership but does not override Amendment 002.
...
- Ticket 07A is the completion gate for the Three-Stage Anchor Mask Pipeline.
